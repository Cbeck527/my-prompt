...
- Made GitHub build provenance conditional on public repository visibility so
...
[Unreleased]: https://github.com/cbeck527/my-prompt/compare/v0.3.0...HEAD
[0.3.0]: https://github.com/cbeck527/my-prompt/compare/v0.2.1...v0.3.0
